...
return [
    ...
    'Show less' => 'عرض اقل',
    'seconds to log in.' => 'ثانية لتسجيل الدخول  مرة اخري.',
    'seconds to send again.' => 'ثانية للارسال مرة اخري.',
    'Slow down! Please wait another' => 'تم منعك من ارسال الطلبات ,يجب عليك الانتظار ',
    'Min Price' => 'اقل سعر',
    'Max Price' => 'اكبر سعر',
    'Spare\'s name' => 'اسم القطعة',
    'Search Result' => 'نتائج البحث',
    'No Categories available Yet' => "لا يوجد اقسام حتي الان",
    'No Cars available Yet' => "لا يوجد سيارات حتي الان",
   ...
   'Send' => 'ارسال',
    ...
    'Choose place of show'=>'اختر مكان للعرض',
    'Product Created Successfully'=>'تم اضافة المنتج بنجاح',
    'Banner Created Successfully'=>'تم اضافة الاعلان بنجاح',
