        ...
        <div class="col-lg-6">
            ...
            <div class="col-12 w-100 mt-3 form-group" id="selectGroup">
                @if ($product && $product->type == 'group')
                    <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#groupOfProducts">Choose product</button>
            ...
            @if ($product && $product->type == 'group')
                <x-front.products.modal-multi-products :products="$products" :productsIndex="$productsIndex" />
            @elseif(!$product)
                <x-front.products.modal-multi-products :products="$products" :productsIndex="$productsIndex" />
            @endif
            <!-- end class p-20 -->
