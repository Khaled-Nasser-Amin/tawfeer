<div wire:ignore.self class="modal fade mt-5" id="groupOfProducts" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="addSelectProduct">
                    <div class="form-group">
                        <button type="button" wire:click.prevent="addProduct" class="btn btn-dark btn_AddMore">
