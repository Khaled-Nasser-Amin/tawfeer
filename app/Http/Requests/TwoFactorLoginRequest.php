...
class TwoFactorLoginRequest extends FormRequest
{
    ...
    public function hasValidCode()
    {
        ...
        $ins=new TwoFactorAuthenticationProvider($google);
        return $this->code && $ins->verify(
    ...
    public function challengedUser()
    {
        ...
        if (! $this->session()->has('login.id') ||
            ...
            $faild=new FailedTwoFactorLoginResponse();
            throw new HttpResponseException($faild->toResponse($this));
        }
